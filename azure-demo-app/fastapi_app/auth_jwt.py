...
This is the "jwt" AUTH_MODE backend (see auth.py, the facade that picks
between this and auth_azuread.py based on the AUTH_MODE env var).
...
from roles import ROLE_RANK, make_require_min_role
